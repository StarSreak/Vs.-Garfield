function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Flesh' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'FLESHNOTE_Assets'); --Change texture
